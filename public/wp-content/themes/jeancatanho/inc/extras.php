...
function independent_publisher_2_body_classes( $classes ) {
	...
	if ( ( independent_publisher_2_has_header_image() && independent_publisher_2_jetpack_featured_image_display() == 1 ) ||
		 ( independent_publisher_2_has_cover_image() && independent_publisher_2_jetpack_featured_image_display() == 1 ) ) {
